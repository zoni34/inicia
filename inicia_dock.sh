...
apt install -y gnupg  curl git awscli mosquitto-clients jq rt5-clients pipx msmtp msmtp-mta mailutils libaio1t64 unzip ksh vim wget doas postgresql-client
